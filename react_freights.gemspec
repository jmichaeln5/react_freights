require_relative "lib/react_freights/version"

Gem::Specification.new do |spec|
  spec.name        = "react_freights"
  spec.version     = ReactFreights::VERSION
  spec.authors     = ["Jonathan Norton"]
  spec.email       = ["jmichaeln5@gmail.com"]
  spec.homepage    = "https://github.com/jmichaeln5/react_freights"
  ...
  spec.metadata["source_code_uri"] = "https://github.com/jmichaeln5/react_freights"
  spec.metadata["changelog_uri"] = "https://github.com/jmichaeln5/react_freights/blob/main/CHANGELOG.md"
